...
router.get(
  ...
  passport.authenticate("jwt", { session: false }),
  (req, res) => getJournalEntry(req, res)
);
...
router.get(
  "/users/:userId/assessments/PHQ9",
  /*passport.authenticate('jwt', {session: false}), */ (req, res) =>
    getPHQ9Entry(req, res)
);
...
router.delete(
  "/users/:userId/assessments/PHQ9",
  /*passport.authenticate('jwt', {session: false}),*/ (req, res) =>
    deletePHQ9Entry(req, res)
);

// @route [GET] users/:id/assessments/GAD7
// @desc Returns all GAD-7 entries
router.get(
  "/users/:userId/assessments/GAD7",
  /*passport.authenticate('jwt', {session: false}), */ (req, res) =>
    getGAD7Entry(req, res)
);
...
router.get(
  "/users/:userId/statistics/trends",
  /*passport.authenticate('jwt', {session: false}), */ (req, res) =>
    getJournalTrend(req, res)
);
